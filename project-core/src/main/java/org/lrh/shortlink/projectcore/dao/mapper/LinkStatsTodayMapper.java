...
public interface LinkStatsTodayMapper extends BaseMapper<LinkStatsTodayDO> {
     ...
     */
    @Insert("INSERT INTO " +
            "t_link_stats_today (full_short_url, date, gid, today_uv, today_pv, today_uip, create_time, update_time, del_flag) " +
            "VALUES( #{linkTodayStats.fullShortUrl},#{linkTodayStats.date},#{linkTodayStats.gid}, #{linkTodayStats.todayUv}, #{linkTodayStats.todayPv}, #{linkTodayStats.todayUip}, NOW(), NOW(), 0) " +
